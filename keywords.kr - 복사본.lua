	...
	[2] = {
		...
		dungeon = {
			[1] = {
				...
				keywords = {"도전모드"},
				excludekeywords = {"일퀘", "강철", "선착", "상층", "상록", "아킨", "묘지", "어묘", "어둠", "정비", "파멸", "파철", "파정", "광산", "잿가루", "피망", "하늘"},
			},
			[2] = {
				name = "무작위 5인 던전",
	...
	[4] = {
		...
		dungeon = {
			...
			[5] = {
				...
				difficulty = {"heroic", "challenge", "normal"},
				keywords = {"전당"},
				excludekeywords = {"시초의전당", "투영의전당", "돌의전당", "번개의전당", "세데크전당", "손의전당"},
			},
			[6] = {
				name = "스칼로맨스",
				difficulty = {"heroic", "challenge", "normal"},
